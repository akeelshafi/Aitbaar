 ...
 * Use the [CustomerCreateProfileFragment.newInstance] factory method to
...
class CustomerCreateProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CustomerCreateProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CustomerCreateProfileFragment().apply {
